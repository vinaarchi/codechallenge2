      ...
      <Navbar />
        ...
        >
          ...
          <p className="text-center mb-6">
            ...
            kesempurnaan. Kami percaya dalam pembelajaran berkelanjutan, dan
            para seniman kami selalu mengikuti tren dan teknik terbaru untuk
            memberikan pengalaman yang luar biasa setiap kali Anda berkunjung.
          </p>
        </div>
        <div className="flex flex-col justify-center items-center p-7">
          ...
          <p className="text-center">
            ...
            inklusivitas, dan keunggulan. Kami merayakan keunikan setiap
            individu dan percaya bahwa seni kuku adalah cara yang kuat untuk
